...
2. **Установить зависимости**:
   ```bash
   make init     # Проверить окружение и установить зависимости backend, BFF и frontend
   # или
   make install  # Установить зависимости backend, BFF и frontend
   ```
...
| Команда | Описание |
|---------|----------|
| `/bootstrap` | Запустить bootstrap-сессию |
