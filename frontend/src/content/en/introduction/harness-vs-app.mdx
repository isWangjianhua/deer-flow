...
<Cards num={2}>
  <Cards.Card title="DeerFlow Harness" href="../harness" />
  <Cards.Card title="DeerFlow App" href="../application" />
</Cards>
...
If you want to go deeper into the runtime itself, continue with the [DeerFlow Harness](../harness). If you want to run DeerFlow as a product, continue with the [DeerFlow App](../application).
