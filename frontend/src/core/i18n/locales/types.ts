...
export interface Translations {
  ...
  auth: {
    ...
    accessTitle: string;
    accessDescriptionLocal: string;
    accessDescriptionOidc: string;
    authModeLocal: string;
    authModeOidc: string;
    languageLabel: string;
    login: string;
    register: string;
    signIn: string;
    signInWithLocal: string;
    createLocalAccount: string;
    signingIn: string;
    creatingAccount: string;
    defaultCredentials: string;
    registrationLocalOnly: string;
    oidcRedirectHint: string;
    ...
    signedInReadyTitle: string;
    signedInReadyDescription: string;
    signedInAs: string;
    sessionTitle: string;
    sessionDescription: string;
    browserSessionIssue: string;
    browserSession: string;
    bffConnection: string;
    signInMode: string;
    userId: string;
    email: string;
    name: string;
    ...
    browserSummaryAuthenticated: string;
    browserSummaryLoading: string;
    browserSummarySignedOut: string;
    bffSummarySignedOut: string;
    bffSummaryConnected: string;
    bffSummaryLoading: string;
    bffLoadFailed: string;
