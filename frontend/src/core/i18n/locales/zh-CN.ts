...
export const zhCN: Translations = {
  ...
  auth: {
    ...
    accessDescriptionOidc: "通过当前配置的身份提供方登录，解锁工作区能力。",
    authModeLocal: "本地 BFF 认证",
    authModeOidc: "OIDC 浏览器会话",
    languageLabel: "语言",
    login: "登录",
    register: "注册",
    signIn: "登录",
    signInWithLocal: "使用本地 BFF 认证登录",
    createLocalAccount: "创建本地账户",
    signingIn: "登录中...",
    creatingAccount: "创建账户中...",
    defaultCredentials: "默认开发账号：",
    registrationLocalOnly: "注册功能仅在本地 BFF 认证模式下可用。",
    oidcRedirectHint: "你将跳转到当前配置的身份提供方进行登录。",
    loginRequiredTitle: "先登录再发送这条消息",
    loginRequiredDescription:
      "你的草稿会保留在输入框里。先在这里完成登录，准备好后再回到输入框确认发送。",
    ...
    sessionDescription:
      "查看浏览器登录状态、确认 BFF 连接是否正常，并在需要时再展开诊断信息。",
    browserSessionIssue: "浏览器会话异常",
    browserSession: "浏览器会话",
    bffConnection: "BFF 连接",
    signInMode: "登录模式",
    userId: "用户 ID",
    email: "邮箱",
    name: "名称",
    ...
    browserSummaryAuthenticated: "浏览器会话已激活，可以正常访问 BFF。",
    browserSummaryLoading: "正在检查是否可以恢复已有浏览器会话。",
    browserSummarySignedOut: "登录后即可使用需要鉴权的工作区能力。",
    bffSummarySignedOut: "登录后才会开始执行 BFF 健康检查。",
    bffSummaryConnected: "BFF /me 桥接请求已成功返回。",
    bffSummaryLoading: "正在加载鉴权后的 BFF 用户信息。",
    bffLoadFailed: "加载 BFF 用户信息失败",
    diagnosticsTitle: "诊断信息",
    diagnosticsDescription:
      "原始会话和 BFF 返回内容默认折叠，避免页面再次变成偏调试视图。",
    showDetails: "显示详情",
    hideDetails: "隐藏详情",
    browserPayload: "浏览器会话原始数据",
    bffPayload: "BFF /me 原始数据",
  },
